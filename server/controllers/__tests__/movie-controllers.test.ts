...
const mockedCachingHelper = CachingHelper.getInstance as jest.Mock;
...
describe("Movie Controllers", () => {
  ...
  describe("getPopularMovies", () => {
    ...
    it("should return popular movies successfully", async () => {
      ...
      mockedCachingHelper.mockReturnValue(mockCacheInstance as any);
    ...
    it("should handle errors properly", async () => {
      ...
      mockedCachingHelper.mockReturnValue(mockCacheInstance as any);
      mockedServices.fetchPopularMovies.mockRejectedValue(
        new Error("API Error")
      );
  ...
  describe("searchMovies", () => {
    ...
    it("should search movies successfully", async () => {
      ...
      expect(response.status).toBe(200);
      expect(response.body).toEqual(mockData);
      expect(mockedServices.searchMoviesByTitle).toHaveBeenCalledWith(
        "test",
        1
      );
    });
    ...
    it("should handle errors properly", async () => {
      ...
      mockedCachingHelper.mockReturnValue(mockCacheInstance as any);
      mockedServices.searchMoviesByTitle.mockRejectedValue(
